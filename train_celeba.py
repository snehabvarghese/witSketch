...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if (epoch + 1) % 10 == 0 or epoch == EPOCHS - 1:
            torch.save(generator.state_dict(), f"{CHECKPOINT_DIR}/generator_celeba_epoch_{epoch+1}.pth")
            torch.save(discriminator.state_dict(), f"{CHECKPOINT_DIR}/discriminator_celeba_epoch_{epoch+1}.pth")
